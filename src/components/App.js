...
export default function App() {
  ...
  return (
    <div className='app-friends container'>
      ...
      {/* What prop/props does FriendsList need? Passing getFilteredFriends() is STRETCH */}
      <FriendsList friends={/* the filtering is stretch */ getFilteredFriends()} changeStatus={changeStatus} />
    </div>
  )
}